...
<body>
    <div class="container py-4">
        <div class="heading text-center">
            <h3 class="mb-1">Laporan Keuangan PT Sembilan Hakim Nusantara</h3>
        ...
        <div class="row my-3 d-flex align-items-center ">
            ...
            <div class="col-md-1 d-flex inline-block justify-content-end d-print-none">
                <a href="<?= base_url(); ?>/laporan-keuangan" class="btn btn-secondary btn-sm mr-1">Back</a>
        ...
        <div class="table-responsive">
            <table class="table table-bordered text-center">
                ...
                <tbody >
                    <?php $no =1; $ttl = 0; foreach($pengeluaran as $p): $ttl += $p['total']; ?>
                    <tr>
                    ...
                    <?php endforeach ?>
                    <?php $nom = $no; $ttl =0; foreach($gaji as $g): $ttl += $g['gapok']+$g['b'] ?>
                        <tr>
                          ...
                          <td class="align-middle">Rp. <?= number_format($g['gapok']+$g['b']); ?></td>
                        </tr>
                    <?php endforeach ?>
                    <tr class="font-weight-bold">
                        <td class="align-middle" colspan="4">Total Keseluruhan</td>
                        <td class="align-middle">Rp. <?= number_format($ttl); ?></td>
                    </tr>
                </tbody>
            </table>        
        </div>
